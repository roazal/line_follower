...
class Servo:
    ...
    def __angle_to_u10_duty(self, angle):
        return int((angle - self.min_angle) * self._angle_conversion_factor) + self._min_u10_duty


    def __initialise(self, pin):
        self.current_angle = -0.001
        self._angle_conversion_factor = (self.max_u10_duty - self._min_u10_duty) / (self.max_angle - self.min_angle)
